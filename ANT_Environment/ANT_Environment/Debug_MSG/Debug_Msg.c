...
//Funckja wysyla informacje diagnostyczną
...
#ifdef WIN32
   //Jeśli jest to aplikcja win32
   //wiadomość zostanie wyświetlona w konsoli
   printf(pMessage);
   return STATUS_SUCCESS;
#else
   //Jeśli jest to aplikacja na mikrokontroler
   //wiadomość zostanie wysłana na odpowiedni interfejs UART
